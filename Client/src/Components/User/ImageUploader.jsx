...
const ImageUploader = () => {
  ...
  const fetchFilteredProjects = async (classification) => {
    ...
    try {
      ...
      const genAI = new GoogleGenerativeAI("AIzaSyBeaivuBDufjfqWN5I75qO1HcDDfv-v-Eg"); // Add your Gemini API key here
    ...
    <div className="max-w-md mx-auto p-6 bg-white shadow-md rounded-lg">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {previewURL && (
                ...
                <p className=" font-medium text-gray-700 mb-2  text-xl" >Preview:</p>
